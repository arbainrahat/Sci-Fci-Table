Shader "DistanceGradient/Color/LowPoly/11ColorLowPoly"
{
	Properties
	{
		...
		// Tenth Color Public Variables

		_Color10 ("Tenth Tint", Color) = (1, 1, 1, 1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (g2f i) : SV_Target
			{
				...
				float3 albedo10 = DiffuseAndSpecularFromMetallic(_Color10, _Metallic10, specularTint, oneMinusReflectivity);
